class ProcesadorMensajes:
    ...
    Methods:
      __init__(df):
        Constructor de la clase ProcesadorMensajes. Inicializa la clase con un DataFrame.
...
class AnalizadorMensajes(ProcesadorTexto):
    '''
    ...
    def __init__(self, df):
        '''
        Constructor de la clase AnalizadorMensajes. Hereda de ProcesadorMensajes.
    ...
    def __str__(self):
        '''
        Método que retorna la información del DataFrame de la clase AnalizadorMensajes.
